...
<div class="container-fluid">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4 gap-3">
        <div>
            <h4 class="fw-bold mb-1 text-dark">Edit Menu</h4>
            <p class="text-muted mb-0 small">Perbarui informasi menu sistem.</p>
        </div>
            ...
            <form action="{{ route('menu.update', $menu->id) }}" method="POST">
                ...
                <div class="card-clean">
                    <div class="card-header-clean">
                        <span class="fw-bold text-uppercase text-primary small"><i class="bi bi-pencil-square me-2"></i> Form Edit Menu</span>
                    </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="title" class="form-control" 
                                       value="{{ old('title', $menu->title) }}" placeholder="Contoh: Dashboard" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="url" class="form-control" 
                                           value="{{ old('url', $menu->url) }}" placeholder="Contoh: dashboard/index">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="icon" class="form-control" 
                                           value="{{ old('icon', $menu->icon) }}" placeholder="Contoh: solar:home-smile">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="order" class="form-control" 
                                       value="{{ old('order', $menu->order) }}" placeholder="Urutan (Contoh: 1)" required>
                            </div>
                                    ...
                                    <select class="form-control select2-multiple" name="role_ids[]" multiple="multiple" data-placeholder="Pilih Role yang diizinkan...">
                                        @foreach($roles as $role)
                                            <option value="{{ $role->name }}" 
                                                @if(is_array($menu->role_id) && in_array($role->name, $menu->role_id)) 
                                                    selected 
                                                @elseif(is_string($menu->role_id) && in_array($role->name, json_decode($menu->role_id) ?? [])) 
                                                    selected 
                                                @endif
                                            >
                                                {{ $role->name }}
                    ...
                    <div class="card-footer bg-white border-top p-4">
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('menu.index') }}" class="btn btn-light border px-4 fw-bold text-muted">Batal</a>
                            <button type="submit" class="btn btn-lrt-primary px-5 shadow-sm">
                                <i class="bi bi-check-circle me-2"></i> Update Menu
                            </button>
                        </div>
                    </div>
                </div>
