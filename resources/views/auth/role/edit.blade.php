...
<div class="container-fluid">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4 gap-3">
        <div>
            <h4 class="fw-bold mb-1 text-dark">Edit Role</h4>
            <p class="text-muted mb-0 small">Perbarui informasi role sistem.</p>
        </div>
    ...
    <div class="row">
        <div class="col-12 col-lg-6"> {{-- Gunakan col-lg-6 agar layout proporsional --}}
            <form action="{{ route('role.update', $roles->id ) }}" method="POST">
                ...
                <div class="card-clean">
                    <div class="card-header-clean">
                        <span class="fw-bold text-uppercase text-primary small"><i class="bi bi-pencil-square me-2"></i> Form Edit Role</span>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" 
                                   ...
                                   placeholder="Contoh: Superadmin" required>
                            <div class="form-text text-muted small mt-2">
                                Pastikan nama role mudah dipahami dan unik.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-footer bg-white border-top p-4">
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('role.index') }}" class="btn btn-light border px-4 fw-bold text-muted">Batal</a>
