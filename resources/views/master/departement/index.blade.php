                ...
                <div class="card-body p-4">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                        <div>
                            ...
                            <p class="text-muted mb-0">Data department mengikuti master organisasi dari Signal.</p>
                        </div>
                        <div class="d-flex gap-2">
                            <form action="{{ route('department.sync-signal') }}" method="POST" class="m-0 sync-signal-form">
                                @csrf
